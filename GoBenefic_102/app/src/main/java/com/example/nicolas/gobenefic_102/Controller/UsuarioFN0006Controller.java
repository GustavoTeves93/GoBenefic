...
public class UsuarioFN0006Controller {
    //DECLARACIONES
    public final String SOAP_ACTION ="http://ws.sos.idat.edu.pe/FN0006";
    public final String OPERATION_NAME ="FN0006";
    ...
    //CONSTRUCTOR
    public UsuarioFN0006Controller() {
        soapClient = new SoapClient();
    }

    public JSONObject FN006(HashMap mapParametros){
        try {
